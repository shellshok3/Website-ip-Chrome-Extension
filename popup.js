...
document.querySelector('#copyToClipboard').addEventListener('click', function() {
	// content script
	chrome.extension.sendMessage({ name: 'copyIP'});
});

document.querySelector('#reverce_page').addEventListener('click', function() {
	// content script
	chrome.extension.sendMessage({ name: 'Reverce'});
});

document.querySelector('#bingloockup').addEventListener('click', function() {
	// content script
	chrome.extension.sendMessage({ name: 'bing'});
});
